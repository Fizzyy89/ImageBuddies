...
export async function loadImageGrid({
    ...
    try {
        ...
        displayedFiles.forEach((fileObj, idx) => {
            ...
            let cardClasses = 'image-card relative bg-white dark:bg-slate-900 rounded-2xl overflow-hidden cursor-pointer transition-all duration-200 hover:scale-[1.03] hover:shadow-xl hover:z-10';
