...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // API Configuration
    const API_URL_GENERATIONS = 'api/openai_proxy.php?endpoint=generations';
    const API_URL_EDITS = 'api/openai_proxy.php?endpoint=edits';
    ...
    async function checkAdminStatus() {
        try {
            const response = await fetch('api/session_auth.php?action=status');
